...
<section class="flex min-h-[500px] items-center justify-start bg-[linear-gradient(90deg,rgba(5,22,48,0.9)_0%,rgba(11,45,92,0.78)_43%,rgba(7,94,184,0.34)_100%),linear-gradient(180deg,rgba(4,18,39,0.38),rgba(4,18,39,0.52)),url('/images/hero-background.png')] bg-cover bg-center px-5 py-16 text-left text-white min-[521px]:min-h-[560px] min-[521px]:px-[70px] min-[521px]:py-20">
    <div class="max-w-[880px] [text-shadow:0_3px_18px_rgba(0,0,0,0.28)]">
        ...
        <div class="flex flex-wrap gap-3.5">
            <a href="/services" class="inline-flex min-h-[46px] w-full items-center justify-center rounded-lg border border-transparent bg-white px-[26px] py-[13px] font-extrabold text-brand-800 no-underline transition hover:-translate-y-0.5 hover:bg-[#eef7ff] min-[521px]:w-auto">Explore Services</a>
            <a href="/contact" class="inline-flex min-h-[46px] w-full items-center justify-center rounded-lg border border-soft-border bg-white px-[26px] py-[13px] font-extrabold text-brand-700 no-underline transition hover:-translate-y-0.5 hover:border-[#b9d8f4] hover:bg-brand-100 min-[521px]:w-auto">Contact Us</a>
        </div>
    </div>
</section>
...
<section class="bg-brand-50 px-6 py-16 text-center min-[861px]:px-[70px] min-[861px]:py-20">
    ...
    <div class="mx-auto grid max-w-[1100px] grid-cols-1 gap-[30px] min-[861px]:grid-cols-3">
        <div class="rounded-lg border border-soft-border bg-white px-7 py-[34px] text-left shadow-brand">
            ...
            <a href="/services" class="font-extrabold text-brand-700 no-underline hover:text-brand-900">View services</a>
        </div>
    ...
    <a href="/services" class="mt-9 inline-flex min-h-[46px] w-full items-center justify-center rounded-lg border border-transparent bg-brand-700 px-[26px] py-[13px] font-extrabold text-white no-underline shadow-[0_14px_28px_rgba(7,94,184,0.25)] transition hover:-translate-y-0.5 hover:bg-brand-800 min-[521px]:w-auto">View All Services</a>
</section>
...
<section class="bg-white px-6 py-16 text-center min-[861px]:px-[70px] min-[861px]:py-20">
    ...
    <div class="grid grid-cols-1 gap-[18px] min-[861px]:grid-cols-3">
        <div class="rounded-[14px] border border-soft-border bg-white p-[18px] text-left font-extrabold text-brand-800 shadow-brand">
...
<section class="bg-brand-50 px-6 py-16 text-center min-[861px]:px-[70px] min-[861px]:py-20">
    <h2 class="mb-[22px] text-center text-[34px] font-bold text-brand-800">Contact Details</h2>
    <div class="mx-auto grid max-w-[1100px] grid-cols-1 gap-[18px] text-left min-[861px]:grid-cols-3">
        ...
        <div class="grid gap-2 rounded-[14px] border border-soft-border bg-white p-[22px] shadow-brand transition hover:-translate-y-1 hover:shadow-brand-lg">
            <span class="font-bold text-muted">Consultation Hours</span>
            <strong class="leading-[1.4] text-brand-800">Available every day</strong>
        </div>

        <div class="grid gap-2 rounded-[14px] border border-soft-border bg-white p-[22px] shadow-brand transition hover:-translate-y-1 hover:shadow-brand-lg">
            <span class="font-bold text-muted">Branches</span>
            <strong class="leading-[1.4] text-brand-800">Kandy and Colombo</strong>
        </div>
    </div>

    <a href="/contact" class="mt-9 inline-flex min-h-[46px] w-full items-center justify-center rounded-lg border border-transparent bg-brand-700 px-[26px] py-[13px] font-extrabold text-white no-underline shadow-[0_14px_28px_rgba(7,94,184,0.25)] transition hover:-translate-y-0.5 hover:bg-brand-800 min-[521px]:w-auto">Contact Us</a>
</section>
